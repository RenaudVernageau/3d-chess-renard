    ...
    <div className="max-w-3xl mx-auto px-4 py-12 text-stone-200">
      ...
      <section className="mb-6">
        <p>
          ...
          fonctionnement du service (compte, avatar, messagerie, parties). Aucune
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          maintien de session). Aucun cookie de mesure d’audience ou publicitaire
          n’est déposé. Si des cookies non essentiels sont ajoutés ultérieurement,
