...
export function OwnProfile() {
  const { user } = useAuth();      // user = { userId, username, ... }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-stone-100 dark:from-stone-800 dark:to-stone-900">
      <form onSubmit={handleSubmit} className="bg-stone-800 p-8 rounded-lg shadow-xl w-full max-w-md mx-auto">
        <h1 className="text-3xl font-bold text-white mb-6 text-center">Mon profil</h1>
...
export function UserProfile() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-stone-100 dark:from-stone-800 dark:to-stone-900">
      <div className="bg-stone-800 p-6 rounded-lg shadow-xl w-full max-w-md mx-auto">
        ...
        {!isFriend && (
          <button
            ...
            className="w-full mb-4 flex items-center justify-center space-x-2 py-2 bg-green-600 hover:bg-green-700 rounded"
          >
            Ajouter en ami
          </button>
        )}
