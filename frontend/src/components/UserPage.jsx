...
/* -------- Profil d’un autre utilisateur (affichage public, DA UsersList) -------- */
      ...
      <div className="w-full max-w-md bg-stone-800 text-white rounded-2xl border border-stone-700 p-8 shadow text-center">
        <div className="flex flex-col items-center space-y-4">
          <img
            ...
            alt={data.username}
            className="w-16 h-16 rounded-full object-cover ring-2 ring-stone-600"
            onError={(e) => {
              e.currentTarget.src = "/default-avatar.jpg";
            }}
          />
          ...
          {data.email ? (
            <p className="text-sm text-stone-400">{data.email}</p>
          ) : null}
