                  ...
                  <>
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="underline underline-offset-2 break-all select-text cursor-pointer hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-white/30 px-0"
